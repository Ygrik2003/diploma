\begin{figure}[ht]
    ...
    \resizebox{0.8\columnwidth}{!}{
        ...
        \node[operation] (residual) at (6,0) {$\mathcal{F}:= f(u, x_i, \frac{\partial{u}}{\partial{x_i}}, \frac{\partial^2{u}}{\partial{x_i^2}})$};
        ...
        \node[circle, draw, fill=purple!70, minimum size=0.8cm] (adapt) at (-1,-5) {$a_i^k$};

        % Decision diamond
        \node[decision] (decision) at (-5,-7) {$< \epsilon$};

        % Final state
        \node (done) at (-5,-10) {Done};
